...
<!-- catalog-digest: sha256:ff7e0913db7b68a0e4965769dd033518fe5bbcf1c1fc0e5415bcf7f6ebb9285c -->
...
|---|---|
| Immediate packs | 24 |
| Recursive files | 5963 |
| Total bytes | 197620622 (188.5 MiB) |
| Extension counts | .aseprite 33, .css 18, .csv 1, .gif 2, .gpl 1, .html 67, .js 52, .json 111, .md 68, .ogg 64, .ora 1, .png 4414, .ps1 2, .py 2, .rpy 2, .svg 916, .txt 11, .wav 176, .webp 22 |
| Corpus digest | `sha256:08e35633a15eac784e09e80fe9ee88d3e9a84a6f0b3851d7abe38dcda69c5438` |
...
Every pack in the corpus is licensed third-party or locally exported material whose terms permit use inside finished products and prohibit redistribution of the raw files. This repository is a public component library, so the shipping posture for every pack is at most `derived-technique-only`: requirements and technique may be learned, source is never copied. The exceptions below are packs whose local evidence cannot establish even the finished-product facts.

| Evidence strength | Packs | Consequence |
|---|---|---|
| Pack license file present (11 packs) | `achievement-toast-notification-system-html5`, `gilded-grove-alchemy-card-pack`, `impact-juice-combat-polish-bundle`, `moonlit-pact-vn-gui-kit-renpy`, `obsidian-grimoire-ui`, `pixel-combat-text-status-fx-kit`, `runic-fantasy-ui-tabs`, `runic-relic-rpg-icons-144`, `tiny-save-settings-menu-starter`, `tiny-ui-sfx-pack`, `ui-feedback-sfx-pack-v2` | Facts recorded from local terms; posture `derived-technique-only` |
| README defers to purchase-page terms (2 packs) | `equipment-compare-ui-pack`, `explorer-map-ui-pack` | Facts `unclear`; posture and disposition `license-review-required` |
| No terms found (11 packs) | `card-system-pixel`, `inventory-grid-grabber-html5`, `inventory-loot-and-legend-inventory-pro`, `neon-rpg-icon-pack`, `neon-ui-mega-bundle`, `progression-system-complete`, `quest-journal-codex-ui-kit`, `skill-progression-system-complete`, `ui-rpg-cards`, `ui-tabs-fantasy-html5-tabs-pack`, `ui-theme-dark-fantasy` | Facts `unclear`; posture and disposition `license-review-required` |
...
| `card-system-pixel` | none-found | unclear / unclear / unclear | license-review-required |
| `equipment-compare-ui-pack` | readme-external-terms | unclear / unclear / unclear | license-review-required |
| `explorer-map-ui-pack` | readme-external-terms | unclear / unclear / unclear | license-review-required |
...
| `inventory-grid-grabber-html5` | none-found | unclear / unclear / unclear | license-review-required |
| `inventory-loot-and-legend-inventory-pro` | none-found | unclear / unclear / unclear | license-review-required |
| `moonlit-pact-vn-gui-kit-renpy` | pack-license-file | supported / not-supported / not-supported | derived-technique-only |
| `neon-rpg-icon-pack` | none-found | unclear / unclear / unclear | license-review-required |
| `neon-ui-mega-bundle` | none-found | unclear / unclear / unclear | license-review-required |
...
| `progression-system-complete` | none-found | unclear / unclear / unclear | license-review-required |
| `quest-journal-codex-ui-kit` | none-found | unclear / unclear / unclear | license-review-required |
...
| `skill-progression-system-complete` | none-found | unclear / unclear / unclear | license-review-required |
...
| `ui-rpg-cards` | none-found | unclear / unclear / unclear | license-review-required |
| `ui-tabs-fantasy-html5-tabs-pack` | none-found | unclear / unclear / unclear | license-review-required |
| `ui-theme-dark-fantasy` | none-found | unclear / unclear / unclear | license-review-required |

Interpretation notes, flagged for operator confirmation in UIREF-001: licenses that are complete but silent on attribution are recorded as `not-supported` ("no attribution requirement appears in local terms") rather than `unclear`, because the local evidence is present and imposes no such requirement. Two raw Rosebud exports carry no terms while their cleaned twins ship licenses (see OVL-001 and OVL-002); UIREF-003 asks whether the twin's terms govern the family for planning purposes.
...
| `card-system-pixel` | Card System Pixel (Aseprite card library) | visual-source, editable-source | CAP-011, CAP-012 | OVL-009 | license-review-required |
| `equipment-compare-ui-pack` | RPG Equipment Compare UI Pack | visual-source, layout-manifest, data-recipe | CAP-008, CAP-010, CAP-011, CAP-017 | — | license-review-required |
| `explorer-map-ui-pack` | Explorer Map UI Pack | visual-source, layout-manifest, data-recipe | CAP-007 | — | license-review-required |
...
| `impact-juice-combat-polish-bundle` | Impact Juice Combat Polish Bundle | visual-source, audio-source, data-recipe, layout-manifest | CAP-005, CAP-006, CAP-013 | — | reference-lab-candidate |
| `inventory-grid-grabber-html5` | GridGrabber Grid Inventory (Rosebud export) | interactive-code, documentation | CAP-010 | OVL-006 | license-review-required |
| `inventory-loot-and-legend-inventory-pro` | Loot and Legend Inventory Pro | interactive-code, visual-source, documentation | CAP-010, CAP-011, CAP-017 | OVL-006 | license-review-required |
...
| `neon-rpg-icon-pack` | Neon RPG Icon Pack | visual-source, documentation | CAP-016 | OVL-007 | license-review-required |
| `neon-ui-mega-bundle` | Neon UI Mega Bundle | interactive-code, documentation | CAP-004, CAP-018, CAP-020 | OVL-004 | license-review-required |
...
| `pixel-combat-text-status-fx-kit` | Pixel Combat Text & Status FX Kit | visual-source, editable-source, data-recipe, documentation | CAP-005, CAP-006 | — | reference-lab-candidate |
| `progression-system-complete` | Progression System Complete (bundle snapshot one) | interactive-code, documentation | CAP-001, CAP-003, CAP-014, CAP-019 | OVL-003, OVL-004, OVL-005, OVL-011 | license-review-required |
| `quest-journal-codex-ui-kit` | Quest Journal + Codex UI Kit | visual-source, layout-manifest, data-recipe | CAP-001, CAP-009, CAP-017 | — | license-review-required |
...
| `skill-progression-system-complete` | Skill Progression System Complete (bundle snapshot two) | interactive-code | CAP-001, CAP-003, CAP-014, CAP-019 | OVL-003, OVL-004, OVL-005, OVL-011 | license-review-required |
...
| `ui-rpg-cards` | UI RPG Cards (Aseprite sheets) | visual-source, editable-source | CAP-011, CAP-012 | OVL-009 | license-review-required |
| `ui-tabs-fantasy-html5-tabs-pack` | Runic Tab-Craft (raw Rosebud export) | interactive-code | CAP-002 | OVL-002 | license-review-required |
| `ui-theme-dark-fantasy` | Obsidian Grimoire UI (raw Rosebud export) | interactive-code, visual-source | CAP-018, CAP-021 | OVL-001 | license-review-required |

Every pack carries at least one evidence-supported capability or an explicit review disposition; no record is silently empty.
...
| CAP-005 | Combat feedback recipes | 3 | 2 | 3 | 2 | 3 | 3 | 3 | 19 | ready-to-spec | impact-juice-combat-polish-bundle, pixel-combat-text-status-fx-kit |
| CAP-006 | Combat text and status FX presentation | 3 | 2 | 3 | 2 | 3 | 2 | 3 | 18 | ready-to-spec | pixel-combat-text-status-fx-kit, impact-juice-combat-polish-bundle |
...
| CAP-010 | Inventory grid and rarity | 3 | 3 | 2 | 2 | 1 | 2 | 2 | 15 | needs-license-review | inventory-grid-grabber-html5, inventory-loot-and-legend-inventory-pro, equipment-compare-ui-pack |
| CAP-007 | Map and minimap chrome | 2 | 3 | 2 | 2 | 1 | 2 | 3 | 15 | needs-license-review | explorer-map-ui-pack |
| CAP-017 | Tooltip and stat deltas | 2 | 3 | 2 | 3 | 1 | 2 | 2 | 15 | needs-license-review | equipment-compare-ui-pack, inventory-loot-and-legend-inventory-pro, quest-journal-codex-ui-kit |
| CAP-008 | Equipment compare surface | 3 | 3 | 2 | 1 | 1 | 2 | 2 | 14 | needs-license-review | equipment-compare-ui-pack |
| CAP-009 | Quest journal and codex | 2 | 3 | 1 | 2 | 1 | 2 | 3 | 14 | needs-license-review | quest-journal-codex-ui-kit |
...
| CAP-018 | Meter and status bar family | 3 | 3 | 1 | 1 | 2 | 3 | 3 | 16 | ready-to-spec | obsidian-grimoire-ui, ui-theme-dark-fantasy, neon-ui-mega-bundle |
...
| CAP-005 | Combat feedback recipes | 3 | 2 | 3 | 2 | 3 | 3 | 3 | 19 | ready-to-spec | impact-juice-combat-polish-bundle, pixel-combat-text-status-fx-kit |
| CAP-006 | Combat text and status FX presentation | 3 | 2 | 3 | 2 | 3 | 2 | 3 | 18 | ready-to-spec | pixel-combat-text-status-fx-kit, impact-juice-combat-polish-bundle |
| CAP-013 | UI feedback audio mapping | 3 | 1 | 2 | 1 | 3 | 2 | 3 | 15 | needs-game-proof | tiny-ui-sfx-pack, ui-feedback-sfx-pack-v2, impact-juice-combat-polish-bundle, moonlit-pact-vn-gui-kit-renpy |
...
| GC-002 | Rogue Cellar Crawl | candidate | moderate | Canvas 2D tile roguelike with field-of-view, turn scheduling, and item generation | Canvas host chrome, inventory grid with rarity tiers, equipment compare, tooltips, minimap, quest log, and save slots | `equipment-compare-ui-pack`, `explorer-map-ui-pack`, `inventory-grid-grabber-html5`, `inventory-loot-and-legend-inventory-pro`, `neon-rpg-icon-pack`, `obsidian-grimoire-ui`, `quest-journal-codex-ui-kit`, `runic-fantasy-ui-tabs`, `runic-relic-rpg-icons-144`, `ui-tabs-fantasy-html5-tabs-pack`, `ui-theme-dark-fantasy` | Two to three specs mirroring the Vector Vortex arc: core playable, shell and UI, then polish | Its strongest evidence sits in license-unclear packs, so terms posture gates the module specs |
...
**Recommendation.** The operator records the purchase-page terms with purchase records (outside this repository), after which the catalog re-audits and the packs leave `license-review-required`.
